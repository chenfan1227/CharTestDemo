...
import com.ccy.lnb.en.adapters.settingAds.BluetoothAdapter;
...
import com.ccy.lnb.en.utils.LogUtil;
...
public class BluetoothActivity extends BaseActivity implements BluetoothBLE.onBuleStatus, BluetoothConnectListener {
    ...
    @Bind(R.id.activity_bluetooth_recycler)
    RecyclerView mRecycler;
    @Bind(R.id.activity_bluetooth_tv_scan)
    TextView mTvScan;
    @Bind(R.id.activity_bluetooth_tv_connect_status)
    TextView mTvConnectStatus;
    @Bind(R.id.activity_bluetooth_bt_search)
    Button mBtSearch;
    @Bind(R.id.activity_bluetooth_bt_auto)
