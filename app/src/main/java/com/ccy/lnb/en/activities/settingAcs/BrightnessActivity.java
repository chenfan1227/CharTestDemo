...
public class BrightnessActivity extends BaseActivity {
    @Bind(R.id.brightness_check_one)
    ImageView mCheckOne;
    @Bind(R.id.brightness_check_two)
    ImageView mCheckTwo;
    @Bind(R.id.brightness_check_there)
    ImageView mCheckThere;
    @Bind(R.id.brightness_check_for)
    ImageView mCheckFor;
    @Bind(R.id.bluetooth_Number)
    TextView mBluetoothNumber;
    @Bind(R.id.image_button)
    ImageView mButton;
    @Bind(R.id.brightness_LinearLayout_one)
    LinearLayout mLinearLayoutOne;
    @Bind(R.id.brightness_LinearLayout_two)
    LinearLayout mLinearLayoutTwo;
    @Bind(R.id.brightness_LinearLayout_there)
    LinearLayout mLinearLayoutThere;
    @Bind(R.id.brightness_LinearLayout_for)
    LinearLayout mLinearLayoutFor;
    @Bind(R.id.brightness_LinearLayout)
