...
public class FontModeActivity extends BaseActivity {
    @BindView(R.id.radioButton_up)
    RadioButton mUp;
    @BindView(R.id.radioButton_fast)
    RadioButton mFast;
    @BindView(R.id.radioButton_left)
    RadioButton mLeft;
    @BindView(R.id.radioButton_mid)
    RadioButton mMid;
    @BindView(R.id.radioButton_slow)
    RadioButton mSlow;
    @BindView(R.id.radioButton_Direction)
    RadioGroup mDirection;
    @BindView(R.id.radioButton_speed)
    RadioGroup mSpeed;
    @BindView(R.id.FontMode_button_save)
    Button mSave;
