...
import com.make.char_im.chenfan.activities.pointSendAcs.MyPhraseActivity;
import com.make.char_im.chenfan.adapters.DisplayAdapter;
import com.make.char_im.chenfan.base.BaseFragment;
import com.make.char_im.chenfan.been.DisplayBean;
import com.make.char_im.chenfan.dialogs.NormalDialog;
import com.make.char_im.chenfan.dialogs.YuYinDialog;
...
import com.make.char_im.chenfan.utils.DateUtils;
import com.make.char_im.chenfan.utils.DiyToast;
import com.make.char_im.chenfan.utils.EmoJiUtil;
import com.make.char_im.chenfan.utils.GreenDaoUtil;
...
public class PointSendFrag extends BaseFragment implements ItemClickListener, DisplayAdapter.ItemOnClickInterface {
    ...
    RadioGroup mRgTime;
    @BindView(R.id.frag_display_rb_sec)
    RadioButton mRbSec;

    @BindView(R.id.display_input_linear_write)
    LinearLayout mLinearWrite;
    @BindView(R.id.display_input_linear_speak)
    LinearLayout mLinearSpeak;
    @BindView(R.id.display_input_go_write)
    ImageView mImgGoWrite;
    @BindView(R.id.display_input_img_go_voice)
    ImageView mImgGoVoice;
    @BindView(R.id.display_input_img_word_write)
    ImageView mImgWordW;
    @BindView(R.id.display_input_word_voice)
    ImageView mImgWordV;
    @BindView(R.id.display_input_img_send)
    ImageView mImgSend;
    @BindView(R.id.display_input_et)
    EditText mEtMess;
    @BindView(R.id.display_input_speak)
    Button mTvSpeak;

    @BindView(R.id.frag_display_recycler)
    PullAbleRecyclerView mRecycler;
    @BindView(R.id.display_no_word_linear)
