package com.make.char_im.chenfan.activities.pointSendAcs;
...
import com.make.char_im.chenfan.activities.settingAcs.EditActivity;
import com.make.char_im.chenfan.adapters.pointSendAds.MyPhraseAdapter;
...
public class MyPhraseActivity extends BaseActivity implements MyPhraseAdapter.ItemOnClickInterface{
    ...
    @BindView(R.id.activity_my_phrase)
    PullAbleRecyclerView mRecycler;
    @BindView(R.id.top_bar_tv_right)
    TextView mTvRight;
    @BindView(R.id.activity_my_phrase_no)
    LinearLayout mLinearNoPhrase;
    @BindView(R.id.no_my_phrase_bt_add)
    Button mBtAddPhrase;
